...
export default function App() {
    return (
        <main>
            ...
            <div className='md:grid grid-cols-2 lg:grid-cols-3 pt-20'>
                ...
                <section className='lg:col-span-2 h-screen'>
                    ...
                    <div id='scrollable' className='m-5 flex flex-wrap items-center justify-center gap-4 h-[700px] md:overflow-y-scroll md:border py-10'>
                        <Examples/>
                    </div>
                </section>
            </div>
